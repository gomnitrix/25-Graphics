class RodPendulumScene {
    static create(simulation) {
        ...
        simulation.originalUpdate = simulation.update.bind(simulation);
        simulation.originalDraw = simulation.draw.bind(simulation);
    ...
    static cleanup(simulation) {
        ...
        if (simulation.originalUpdate) {
            simulation.update = simulation.originalUpdate;
            delete simulation.originalUpdate;
        }
        if (simulation.originalDraw) {
            simulation.draw = simulation.originalDraw;
            delete simulation.originalDraw;
        }
    }
}
